...
public class FabricRecycleBin extends RecyclingBin<Fabric> implements IBag<Garbage> {
    ...
    public boolean transferTo(Bag<Garbage> targetBag, Garbage item) {
        if (targetBag.getClass().equals(FabricRecycleBin.class) && item.getType().equals(TYPE)) {
