...
public class MetalRecycleBin extends RecyclingBin<Metal> implements IBag<Garbage> {
    ...
    public boolean transferTo(Bag<Garbage> targetBag, Garbage item) {
        if (targetBag.getClass().equals(MetalRecycleBin.class) && item.getType().equals(TYPE)) {
