...
public class PlasticRecycleBin extends RecyclingBin<Plastic> implements IBag<Garbage> {
    private ArrayList<Garbage> items;
    private static final String TYPE = "Plastic";
    ...
    public boolean transferTo(Bag<Garbage> targetBag, Garbage item) {
        if (targetBag.getClass().equals(PlasticRecycleBin.class) && item.getType().equals(TYPE)) {
