...
public class OrganicRecycleBin extends RecyclingBin<Organic> implements IBag<Garbage> {
    ...
    public boolean transferTo(Bag<Garbage> targetBag, Garbage item) {
        if (targetBag.getClass().equals(OrganicRecycleBin.class) && item.getType().equals(TYPE)) {
