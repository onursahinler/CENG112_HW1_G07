...
public class PaperRecycleBin extends RecyclingBin<Paper> implements IBag<Garbage> {
    ...
    public boolean transferTo(Bag<Garbage> targetBag, Garbage item) {
        if (targetBag.getClass().equals(PaperRecycleBin.class) && item.getType().equals(TYPE)) {
